...
model = pickle.load(open('major_project.pkl', 'rb'))
...
def home():
    ...
    if form.validate_on_submit():
        ...
        if file_name.endswith('.jpg'):
            ...
            img=Image.open(r"C:/Users/mani/Desktop/BLOOD-REPORT-ANALYSIS/static/files/"+file_name)
